**Resumo**: 10 passed, 0 failed, 0 skipped, 10 total

# Relatório de testes (pytest)

- Gerado em: 2026-05-14T00:35:35.648744+00:00
- Exit status: 0

## O que foi validado

- Persistência em **PostgreSQL** (SQLAlchemy + `DATABASE_URL`).
...
### test_persistencia_dados_no_postgresql
